...
function inicjalizacja()
{
	...
	if (p_game===null)
	{
		...
		start_div.setAttribute('style','position: absolute; top: 105px; left: 0px; width: 640px; background-color: transparent; font-size: 85px; color: blue; text-align: center;');
